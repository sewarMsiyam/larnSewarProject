    ...
    <div className="bg-white rounded-3xl p-5 shadow-sm hover:shadow-lg">
      ...
      <div className="flex items-center gap-2 lg:gap-1 xl:gap-2 mb-3">
        {loading ? (
          ...
          <>       
            <Link href={`/course/${id}`}  className="btn-primary text-center font-medium py-2.5 w-full before:ease relative overflow-hidden btn-primary px-1 transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:before:-translate-x-40">اشترك في الكورس</Link>
