                    ...
                    <table className="border-separate border-spacing-y-5 w-full">
                        <thead>
                            <tr>
                                ...
                                <th className="text-start">التلخيص</th>
                                <th className="">#</th>
                            </tr>
                        </thead>
                        <tbody>
                            {lessons.map((lesson, index) => (
                                <>
                                    <tr key={index} className="">
                                        <td className="px-5 py-5 font-bold bg-gray-100 rounded-s-2xl ">{index+1}. {lesson.name}</td>
                                        ...
                                        <td className="px-5 py-5 font-bold bg-gray-100 rounded-e-2xl ">
                                            <div className="relative">
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent>
                                                        <DropdownMenuItem>
                                                            <Link href={`/course/${id}/lessons/update_lessons/${lesson.id}`} className="flex justify-center gap-2 w-full text-center">
                                                                تعديل
