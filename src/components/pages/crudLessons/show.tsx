...
export default function UserCourse() {
    ...
    const handleCancel = () => {
        setIsOpen(false); // إغلاق الـ AlertDialog عند الضغط على إلغاء
    };
                            ...
                            <div className="relative">
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent>
                                        ...
                                        <DropdownMenuItem>
                                            <button onClick={() => handleDeleteClick(course)} className="flex justify-center gap-2 w-full text-center hover:text[#EA4335]">
                                                حذف
